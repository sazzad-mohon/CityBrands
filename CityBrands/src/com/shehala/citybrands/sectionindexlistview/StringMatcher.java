...
public class StringMatcher {
	...
	private final static char KOREAN_UNIT = 'z' - 'a';
//	private final static char[] KOREAN_INITIAL = {'a ±', 'ã„²', 'ã„´', 'ã„·', 'ã„¸', 'ã„¹', 'ã…�', 'ã…‚', 'ã…ƒ', 'ã……'
...
//		}
	...
	private static char getInitialSound(char c) {
		return c ;
				//KOREAN_INITIAL[(c - KOREAN_UNICODE_START) / KOREAN_UNIT];
	}
}
